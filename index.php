...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="css/material.green-red.min.css">
    <link rel="stylesheet" href="styles.css">

  </head>
  <body>
    <div class="demo-blog mdl-layout mdl-js-layout mdl-layout--fixed-header">
  ...
  -->
          ...
          <div class="mdl-card shopping mdl-cell mdl-cell--6-col">
            <div class="mdl-card__media mdl-color-text--grey-50">
        ...
        <footer class="mdl-mini-footer">
            <?php echo date('Y'); ?>&copy;APSS WEB STUDIO &nbsp;
        </footer>
      </main>
